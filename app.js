...
// const WorldCupSquad = [' Babar Azam',  'Shadab Khan', 'Asif Ali', ' Muhammad Rizwan', 'Haider Ali', 'Haris Rauf', 'Iftikhar Ahmed', 'Khushdil Shah', 'Mohammad Hasnain', ' Mohammad Nawaz', 'Mohammad Wasim', 'Azam Khan', 'Naseem Shah', 'Shaheen Shah Afridi', 'Saim Ayub'];
